...
public class Arm extends SubsystemBase {
  ...
  CANSparkMax intake;
  WPI_TalonFX xAxisMotor, yAxisMotor;
  ...
  public Arm() {
    ...
    yAxisMotor = new WPI_TalonFX(ArmConstants.yAxisMotorID);
    xAxisMotor = new WPI_TalonFX(ArmConstants.xAxisMotorID);
  ...
  public double getPosition() {
    ...
    return yAxisMotor.getSelectedSensorPosition() / 2048;
  }

  public double getVelocity() {
    // rotations per second
    return yAxisMotor.getSelectedSensorVelocity() * 10 / 2048;
  }
